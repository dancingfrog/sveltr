...
regarding how much progress we can actually make  on this issue, but 
also an appeal to approach the humanistic, psychological factors of this 
with the same interest to understand the dimensions of the problem as we 
...
probably tell from my meandering considerations that there are many 
