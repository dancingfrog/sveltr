...
<div id="glsl-app" role="main" style="width: 100%;">
&nbsp;
</div>
...
To create custom shaders for use with `@sveltejs/gl`, I had to make some changes to the `gl` source, beginning by adding a declaration to all shaders compile by `Material.mjs`:
